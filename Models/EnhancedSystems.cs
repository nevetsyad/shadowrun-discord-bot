...
public class CharacterContact
{
    ...
    [Required]
    [MaxLength(50)]
    public string ContactType { get; set; } = "Street"; // Street, Corporate, Fixer, Johnson, etc.

    // Contact level (1-3)
    [Range(1, 3)]
    public int Level { get; set; } = 1; // 1=Acquaintance, 2=Associate, 3=Friend

    // Loyalty rating (1-3)
    [Range(1, 3)]
    public int Loyalty { get; set; } = 1; // How loyal the contact is

    // What they can provide
    [MaxLength(200)]
    public string? Specialties { get; set; }

    // Connection rating (how well-connected they are)
    [Range(1, 6)]
    public int Connection { get; set; } = 2;

    // Availability
    public int AvailabilityModifier { get; set; } = 0; // How hard to reach
...
public class HealingAttempt
{
    ...
    [Required]
    public virtual ShadowrunCharacter Character { get; set; } = null!;
    public virtual ShadowrunCharacter? Healer { get; set; }
}
