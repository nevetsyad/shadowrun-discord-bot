    ...
    private List<SlashCommandBuilder> BuildSlashCommands()
    {
        ...
        commands.Add(new SlashCommandBuilder()
            ...
            .AddOption(new SlashCommandOptionBuilder()
                .WithName("create")
                .WithDescription("Create a new Shadowrun character (Priority or Archetype-based)")
                ...
                .AddOption("archetype", ApplicationCommandOptionType.String, "Archetype (Mage, Street Samurai, Shaman, Rigger, Decker, Physical Adept) - OPTIONAL", isRequired: false)
                .AddOption("priority", ApplicationCommandOptionType.String, "Priority level (A, B, C, D, E) - creates priority-based character - OPTIONAL", isRequired: false))
            .AddOption(new SlashCommandOptionBuilder()
                .WithName("list")
